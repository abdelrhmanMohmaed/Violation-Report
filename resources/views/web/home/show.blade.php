...
@section('main')
    <nav class="navbar">
        <div class="container-fluid">
            <form class="d-flex" action="{{ url('/reports-list/search') }}" method="get">
                <input class="form-control me-2" name="seel" type="search" placeholder="Type Seel" aria-label="Search">
                <input class="form-control me-2" name="area" type="search" placeholder="Type Area" aria-label="Search">
