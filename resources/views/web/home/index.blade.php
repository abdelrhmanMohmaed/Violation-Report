...
@section('main')
    <div class="container">
        <div class="card my-5">
            <h5 class="card-header text-center">Violation Report</h5>
            <div class="card-body">
                <form action="{{ url('/upload/report') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row py-2">
                        ...
                        <div class="col-md-6">
                            <div>
                                <strong>Violation Number : </strong> 2202 -
                        ...
                        <div class="col-md-6">
                            <div>
                                <strong>SEEL # :</strong>
                                <select name="seel" class="form-select form-select-sm" aria-label=".form-select-sm example">
                    ...
                    <div class="row py-2">
                        ...
                        <div class="col-md-6">
                            <div>
                                ...
                                <select name="cat" class="form-select form-select-sm" aria-label=".form-select-sm example">
                                    <option disabled selected>Open this select menu</option>
                                    ...
                                    <option value="Welfare and work environmental">Welfare and work environmental</option>
                                    <option value="Working at height">Working at height</option>
                                    <option value="Movement of people and vehicles">Movement of people and vehicles</option>
                    ...
                    <div class="row py-2">
                        ...
                        <div class="col-md-12">
                            <div>
                                ...
                                <textarea name="action" class="form-control" aria-label="With textarea"></textarea>
                            </div>
                            @error('action')
                                {{-- <div class="alert-danger"> --}}
                                <span class="text-danger">
                    ...
                    <div class="row py-2">
                        ...
                        <div class="col-md-6">
                            <div>
                                ...
                                <input class="form-control" type="date" name="target_date" id="date">
                            </div>
                            @error('target_date')
                                {{-- <div class="alert-danger"> --}}
                                <span class="text-danger">
